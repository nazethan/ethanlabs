---
title: Report
description: A comprehensive template for writing the project report, including front matter, chapters, and appendices.
...
- **List of Figures & Tables:** *(Optional)* Essential for IoT projects involving many circuit diagrams and data sheets.
...
:::info
  The **Abstract** is not really a part of the Front Matter, but it is often placed before the main chapters. It should be concise and highlight the key aspects of your project.
:::
...
## **Chapter 6:** The Logbook Section (Weekly Progress)
:::info Example Entry
#### **Project Work Log**
| Month | Week No. | Activity Performed | Remarks | Signature |
| :--- | :--- | :--- | :--- | :--- |
| January | **Week 01** | 01 | Literature survey and component finalization. |  |  |
| " | **Week 02** | Circuit simulation and basic PCB layout design. |  |  |
| " | **Week 03** | Interfacing sensors with ESP32 and testing MQTT. |  |  |
| " | **Week 04** | Developing the UI for the energy tracking dashboard. |  |  |
:::
...
> Appendices are completely optional!
...
:::tip
  Ensure the side-margins is at least **1.0** to **0.75 inches**
:::